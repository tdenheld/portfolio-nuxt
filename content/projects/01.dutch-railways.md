...
items:
  ...
  - copy: |
      ...
      A design system succeeds when it's actually used. To ensure adoption, NS 𐄂 DEPT established a dedicated team (with me as tech lead) and made it mandatory for new features to use the system. Our biggest breakthrough came when I helped rebuild the outdated online ticket sales application from the ground up.
  - src: https://res.cloudinary.com/tibor/image/upload/v1762288755/Koop-een-NS-Dagkaart-NS-11-04-2025_09_38_PM_rlbmob.png
  - copy: |
      I worked closely with UX designers to refine their layouts using our components and built a polished front-end prototype in Angular. This became a benchmark and set the tone for future projects, helping more teams adopt the new design system with confidence and consistency. The improved implementation also led to a 15% increase in customers completing their subscription purchases.
