...
items:
  ...
  - copy: |
      I worked closely with feature teams to refine their layouts and front-end architecture. I built a polished [prototype](https://nessie.netlify.app) in Angular which became a benchmark and set the tone for future projects, helping more teams adopt the new design system with confidence and consistency. The improved implementation also led to a 15% increase in customers completing their subscription purchases.
