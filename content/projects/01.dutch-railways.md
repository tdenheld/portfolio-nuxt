...
descriptionShort: Driving the architecture and implementation of a multi-platform agentic design system at scale.
highlights:
  - title: Involvement
    items:
...
items:
  ...
  - type: image
    ...
    alt: NS intercity train at a railway platform
  - type: copy
    copy: |
      ## Scaling Design
  ...
  - type: image
    ...
    alt: NS design system component documentation
  - type: image
    src: https://res.cloudinary.com/tibor/image/upload/v1758128623/ns-04_chychj.svg
    alt: NS design system interface components
  - type: copy
    copy: |
      ## Building the System
  ...
  - type: image
    ...
    alt: NS design tokens and component examples
  - type: image
    src: https://res.cloudinary.com/tibor/image/upload/v1758128627/ns-06_vrkclb.png
    alt: NS responsive application interface
  - type: copy
    copy: |
      ## Adoption
