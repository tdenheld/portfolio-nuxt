...
items:
  ...
  - copy: |
      ## Building the System
      I craft scalable UI components using Design Tokens, Astro (Static HTML & CSS) and StencilJS (Web Components). This is documented and validated with Playwright, Axe-core and Storybook, with a strong focus on accessibility and maintainability. I actively explore emerging CSS specifications and modern tooling, including AI-assisted workflows. This supports automation, documentation and workflows, enhancing both developer experience and system adoption.
