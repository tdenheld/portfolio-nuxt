...
items:
  ...
  - copy: |
      I collaborated closely with UX designers, refined their layouts using our components, and built a polished front-end prototype in Angular that served as a benchmark for the development team. This approach set the tone for future projects — helping multiple teams transition their products to the new design system with confidence and consistency.
