...
items:
  ...
  - copy: |
      I worked closely with UX designers to refine their layouts using our components and built a polished front-end prototype in Angular. This prototype became a benchmark for the team and set the tone for future projects, helping more teams adopt the new design system with confidence and consistency. The improved implementation also led to a 15% increase in customers completing their subscription purchases.
